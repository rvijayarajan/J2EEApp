...
<c:set var="pageButtons">
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.username"/>
        </th>
        <td>
        <c:choose>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.password"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.confirmPassword"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.firstName"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.lastName"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.addressForm.address"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.addressForm.city"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.addressForm.province"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.addressForm.country"/>
        </th>
        <td>
            <buptlab:country name="countries" toScope="page"/>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.addressForm.postalCode"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.email"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.phoneNumber"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.website"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.passwordHint"/>
        </th>
        <td>
...
<c:choose>
    ...
    <tr>
        <th>
            <buptlab:label key="userForm.roles"/>
        </th>
        <td>
