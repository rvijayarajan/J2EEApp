...
<!--
    ...
    function required () { 
        this.aa = new Array("j_username", "<fmt:message key="user.input"/> <fmt:message key="label.username"/> .", new Function ("varName", " return this[varName];"));
        this.ab = new Array("j_password", "<fmt:message key="user.input"/> <fmt:message key="label.password"/>.", new Function ("varName", " return this[varName];"));
    } 
