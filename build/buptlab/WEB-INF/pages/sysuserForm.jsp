...
<%
	List ModelInfoList = (List) request.getAttribute("NodeList");
...
<title><fmt:message key="sysuserForm.title" /></title>
<html>
<head>
<html:javascript formName="sysuserForm" cdata="false"
...
<body bgcolor="#EDF2F8" leftmargin="0" topmargin="0" marginwidth="0"
	marginheight="0"
	onLoad="MM_preloadImages('../images/common/icons/search_over.gif','../images/common/icons/save_over.gif','../images/common/icons/rewrite_over.gif','../images/common/icons/back_over.gif','../images/common/icons/search_over.gif')">
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td height="20">
		  <img src="<c:url value="/images/common/icons/new_off.gif"/>" width="60" height="20"> 
		  ...
		  <img src="<c:url value="/images/common/icons/edit_off.gif"/>" width="60" height="20"> <img src="<c:url value="/images/common/icons/del_off.gif"/>" width="60"	height="20">
		</td>
	</tr>
	<tr>
	  ...
	  <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
		  ...
		  <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
								...
								<tr>
									...
									<td align="left">
									   <html:text property="name" styleId="name" maxlength="20" /> 
								...
								<tr>
									...
									<td align="left">
									   <html:password property="password" size="20" onchange="passwordChanged(this)" styleId="password" redisplay="true" maxlength="20" />
									   <html:errors property="password" />
									</td>
								</tr>
								<tr>
									<th>
									   <font color="red">*</font><strong>确认密码:</strong>
									</th>
									<td align="left">
						...
						<c:if test="${yhflflag == '0'}">
							    <tr>
									...
									<td align="left">
										  ...
										  </html:select> <html:errors property="yhfl" />
									</td>
								</tr>
						</c:if>
<%-- added by caoruixin 2006-11-07 yhfl--%>
								<tr>
									...
									<td align="left">
									   <html:textarea cols="20" rows="5" property="memo" />
						...
						<tr align="left">
							...
							<table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
								<tr align="left">
									...
									<td height="20" align="left" valign="middle"><fmt:message key="p.s" /></td>
								</tr>
		                    </table>
							</td>
						</tr>
                        ...
                        <tr align="left" id="delTable" style="display:block">
                           ...
                           <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
                              ...
                              <%}else{
                                    ...
                                    {
                                        mInfo = (Node) ModelInfoList.get(i);
                              ...
                              <tr>
                                 ...
                                 <td width="83%" height="25" align="left"><%=mInfo.getCzmc()%></td>
                              </tr>
                              <%}
                              }%>
...
<%--以非admin登陆显示List End--%>											
               <%} else {%>						
<%--JybList  add by cym--%>
						<tr align="left" id="JybTable" style="display:block">
							<td height="14" colspan="3">
							<table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
								<tr>
									<input name="SelectAll" type="button" value="全选" onclick="javascript:chooseAll()">
						...
						<tr align="left">
							<td colspan="3">
							 <div align="center">
							  ...
							  <img src="<c:url value="/images/common/icons/save_on.gif"/>" name="Image32" width="60" height="20" border="0" /></a> 
							  ...
							  <img src="<c:url value="/images/common/icons/rewrite_on.gif"/>"name="Image9" width="60" height="20" border="0"></a>
							 </div>
						    </td>
						</tr>
	  </table>
